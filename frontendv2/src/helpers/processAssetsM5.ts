...
export function processAssetsM5(assets: IAsset[]): IStrategyProcessed {
  // const mhimin = {
  //   name: 'MHI',
    ...
    assets: assets.map(asset => ({
      ...
      candles: asset.candles
        ...
        .map(candle => {
          ...
          const analysisCandle = asset.candles[findCandleIndex - 1];
          ...
          if (entry === asset.candles[findCandleIndex + 1].color) {
            return {
              status: 'win',
              position: 'mg1',
              candle,
          ...
          if (entry === asset.candles[findCandleIndex + 2].color) {
            return {
              status: 'win',
              position: 'mg2',
              candle,
